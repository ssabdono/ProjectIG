...
namespace EncyIG.Handlers
{
    ...
    public class SiteBase : EncyIG.Web.PageBase
    {
        ...
        public static string Copyright
        {
            get
            {
                return "&copy; 2018 EncyIG. ^Copyright^All rights reserved.^Copyright^";
            }
        }
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            string themePath = Server.MapPath("~/App_Themes/EncyIG");
            if (Directory.Exists(themePath))
            	foreach (string stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!(fileName.Equals("_Theme_Social.css")))
                    {
                        ...
                        link.Href = ("~/App_Themes/EncyIG/" + fileName);
