...
using EncyIG.Data;
using EncyIG.Services;

namespace EncyIG.Web
{
    ...
    public class AquariumExtenderBase : ExtenderControl
    {
        ...
        protected override System.Collections.Generic.IEnumerable<ScriptReference> GetScriptReferences()
        {
            ...
            if (!((ci.Name == "en-US")))
            	scripts.Add(new ScriptReference(String.Format("EncyIG.js.sys.culture.{0}.js", ci.Name), assemblyFullName));
            if (EnableMinifiedScript)
            {
                scripts.Add(new ScriptReference("EncyIG.js.sys._System.js", assemblyFullName));
                scripts.Add(new ScriptReference("EncyIG.js.sys.MicrosoftAjax.min.js", assemblyFullName));
                scripts.Add(new ScriptReference("EncyIG.js.sys.AjaxControlToolkit.min.js", assemblyFullName));
                scripts.Add(new ScriptReference("EncyIG.js.sys.MicrosoftAjaxWebForms.min.js", assemblyFullName));
                scripts.Add(new ScriptReference(CultureManager.ResolveEmbeddedResourceName(("EncyIG.js.daf.daf-resources" + fileType)), assemblyFullName));
                scripts.Add(new ScriptReference(("EncyIG.js.daf.daf-menu" + fileType), assemblyFullName));
                scripts.Add(new ScriptReference(("EncyIG.js.daf.daf" + fileType), assemblyFullName));
                scripts.Add(new ScriptReference(("EncyIG.js.daf.daf-odp" + fileType), assemblyFullName));
                if (new ControllerUtilities().SupportsScrollingInDataSheet)
                	scripts.Add(new ScriptReference(("EncyIG.js.daf.daf-extensions" + fileType), assemblyFullName));
                if (EnableCombinedScript)
                	scripts.Add(new ScriptReference(("EncyIG.js.daf.daf-membership" + fileType), assemblyFullName));
        ...
        protected virtual void ConfigureScripts(List<ScriptReference> scripts)
        {
            if (RequiresMembershipScripts && !(EnableCombinedScript))
            	if (EnableMinifiedScript)
                {
                    scripts.Add(new ScriptReference(CultureManager.ResolveEmbeddedResourceName("EncyIG.js.daf.daf-resources.min.js"), GetType().Assembly.FullName));
                    scripts.Add(new ScriptReference("EncyIG.js.daf.daf-membership.min.js", GetType().Assembly.FullName));
                }
                else
                {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            link.ID = "EncyIGTheme";
            link.Href = Page.ClientScript.GetWebResourceUrl(typeof(AquariumExtenderBase), "EncyIG.Theme.Social.css");
