	...
	public partial class DataControllerBase
    {
        ...
        public static ControllerConfiguration CreateConfigurationInstance(Type t, string controller)
        {
            ...
            if (config == null)
            {
                ...
                if ((res == null) || (res == DefaultDataControllerStream))
                	res = ControllerConfigurationUtility.GetResourceStream(String.Format("EncyIG.controllers.{0}.xml", controller), String.Format("EncyIG.{0}.xml", controller));
                if (res == null)
                {
        ...
        protected virtual bool ConfigureCommand(DbCommand command, ViewPage page, CommandConfigurationType commandConfiguration, FieldValue[] values)
        {
            ...
            if (command == null)
            	return true;
            if (values != null)
            	EncyIG.Security.EventTracker.EnsureTrackingFields(page, _config);
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            if (t == null)
            	t = typeof(EncyIG.Data.Controller);
            Stream res = ControllerConfigurationUtility.GetResourceStream(String.Format("EncyIG.Reports.{0}", name), String.Format("EncyIG.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                ControllerConfiguration config = EncyIG.Data.Controller.CreateConfigurationInstance(t, controller);
