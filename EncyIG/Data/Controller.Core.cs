...
using EncyIG.Handlers;
using EncyIG.Services;

namespace EncyIG.Data
{
    ...
    public partial class DataControllerBase : IDataController, IAutoCompleteManager, IDataEngine, IBusinessObject
    {
        ...
        ViewPage IDataController.GetPage(string controller, string view, PageRequest request)
        {
            ...
            EncyIG.Security.EventTracker.Process(page, request);
            if (rules != null)
        ...
        ActionResult IDataController.Execute(string controller, string view, ActionArgs args)
        {
            ...
            try
            {
                ...
                if (args.SqlCommandType != CommandConfigurationType.None)
                	using (DataConnection connection = CreateConnection(this))
                    {
                        EncyIG.Security.EventTracker.Process(args, _config);
        ...
        public virtual string GetSurvey(string surveyName)
        {
            ...
            if (String.IsNullOrEmpty(survey))
            	survey = ControllerConfigurationUtility.GetResourceText(String.Format("EncyIG.Surveys.{0}.min.js", surveyName), String.Format("EncyIG.{0}.min.js", surveyName), String.Format("EncyIG.Surveys.{0}.js", surveyName), String.Format("EncyIG.{0}.js", surveyName));
            if (String.IsNullOrEmpty(survey))
            	throw new HttpException(404, "Not found.");
            if (String.IsNullOrEmpty(layout))
            	layout = ControllerConfigurationUtility.GetResourceText(String.Format("EncyIG.Surveys.{0}.html", surveyName), String.Format("EncyIG.Surveys.{0}.htm", surveyName), String.Format("EncyIG.{0}.html", surveyName), String.Format("EncyIG.{0}.htm", surveyName));
            if (String.IsNullOrEmpty(rules))
            	rules = ControllerConfigurationUtility.GetResourceText(String.Format("EncyIG.Surveys.{0}.rules.min.js", surveyName), String.Format("EncyIG.{0}.rules.min.js", surveyName), String.Format("EncyIG.Surveys.{0}.rules.js", surveyName), String.Format("EncyIG.{0}.rules.js", surveyName));
