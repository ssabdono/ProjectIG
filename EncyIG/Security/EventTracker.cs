...
namespace EncyIG.Security
{
    ...
    public class EventTrackerBase
    {
        ...
        private static Regex _modifiedByUserNameRegex = new Regex("UpdatedBy", RegexOptions.IgnoreCase);
        
        private static Regex _modifiedByUserIdRegex = new Regex("UpdatedBy", RegexOptions.IgnoreCase);
        
        private static Regex _modifiedOnRegex = new Regex("UpdatedOn", RegexOptions.IgnoreCase);
        ...
        private static Regex _createdOnRegex = new Regex("CreatedBy", RegexOptions.IgnoreCase);
