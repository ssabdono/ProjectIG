    ...
    _edit = _touch.edit = {
                    ...
                    if (dataContext && (commandName != 'New' || !dataView.tagged('optimistic-default-values-none'))) {
                        ...
                        if (getPageTemplate) {
                            ...
                            getPageTemplate.Fields.every(function (f) {
                                ...
                                if (itemsStyle && itemsStyle.match(/DropDownList|ListBox|RadioButtonList/) && (f.Items == null || !f.Items.length)) {
        ...
        position: function (page) {
            var changePosition = !isMobileEditor(),
                ...
                dataInput = editor.find('[data-control="field"][data-field="' + _edit.field() + '"]'),
                inputMethod = dataInput.data('input') || '',
                overlayDisplayMode = inputMethod != 'blob';
    ...
    $(document).on('dataitemselect.dataview.app', function (e) {
        ...
        if (e.namespace == 'app' && !_touch.isInTransition())
            ...
            if (_edit.frame(':active')) {
                ...
                if ((key.length == 1 || key == 'Backspace') && !(originalEvent.ctrlKey || originalEvent.altKey || originalEvent.metaKey)) {
                    _input._buffer = key;
                    originalEvent.preventDefault();
