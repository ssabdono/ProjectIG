...
(function () {
    var _app = $app,
        ...
        executeCompressedProperties = [
            ...
            { _m: 'Execute', _r: 'args', Me: ['CommandArgument', 'LastCommandName', 'LastCommandArgument', 'SaveLEVs', 'ContextKey', 'LastView', 'Filter', 'SortExpression', 'SelectedValues', 'ExternalFilter'], Values: ['OldValue', 'Modified', 'ReadOnly', 'Error'] }
        ],
